...
class MaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      brightness: Brightness.light,
      primary: Color(0xff02466e),
      surfaceTint: Color(0xff2e628c),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff4779a3),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff2e628c),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff02466e),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff152431),
      onSecondary: Color(0xffffffff),
      ...
      primaryFixed: Color(0xff02466e),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff002f4d),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff364453),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff1f2e3c),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondaryFixedVariant: Color(0xff081824),
      tertiaryFixed: Color(0xfff1e1ff),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xffd7c3eb),
      onTertiaryFixedVariant: Color(0xff1d102e),
      surfaceDim: Color(0xff101418),
      surfaceBright: Color(0xff36393e),
      surfaceContainerLowest: Color(0xff0b0f12),
      surfaceContainerLow: Color(0xff181c20),
